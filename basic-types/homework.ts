...
console.log(`Is "${text}" longer than 10 characters?`, isLong);

// Exercise 3: Verify if a number is positive
let secondNum: number = 15;
let isPositive: boolean = secondNum > 0;
console.log(`Is ${secondNum} positive?`, isPositive);

// Exercise 4: Determine if a number is negative or zero
let numCheck: number = -3;
let isNonPositive: boolean = numCheck <= 0;
console.log(`Is ${numCheck} non-positive?`, isNonPositive);

// Exercise 5: Check if a string is empty
let stringMessage: string = "";
let isEmpty: boolean = stringMessage === "";
...
console.log(`Is ${rangeNumber} in range 10-100?`, isInRange);
